...
>(function TableBody({ className, ...props }, ref) {
  return (
    <tbody ref={ref} className={tableBodyStyle({ class: className })} {...props} />
  );
});
...
const TableData = React.forwardRef<HTMLTableCellElement, React.ComponentProps<"td">>(
...
>(function TableCaption({ className, ...props }, ref) {
  return (
    <caption ref={ref} className={tableCaptionStyle({ class: className })} {...props} />
  );
});
