...
>(({ className, ...props }, ref) => {
  return (
    <View ref={ref} className={calendarHeaderStyle({ class: className })} {...props} />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <View ref={ref} className={calendarBodyStyle({ class: className })} {...props} />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <View ref={ref} className={calendarGridStyle({ class: className })} {...props} />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <View ref={ref} className={calendarWeekStyle({ class: className })} {...props} />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <View ref={ref} className={calendarFooterStyle({ class: className })} {...props} />
  );
});
